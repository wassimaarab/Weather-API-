...
public class OpenWeatherMapTest {
    ...
    /* Testing getFullData function for OpenWeatherMap for an argument that is not a valid city */
    @Test
    public void getFullDataOpenWeatherMapTest1()  {
        weather.getFullData("regergfe");
        assertNull(weather.aJsonObject);

    }

    /* Testing getFullData function for OpenWeatherMap for an empty argument  */
    @Test
    public void getFullDataOpenWeatherMapTest2() {
        weather.getFullData("");
        assertNull(weather.aJsonObject);
    }

    /* Testing getFullData function for OpenWeatherMap to make sure of its return type */
    @Test
    public void getFullDataOpenWeatherMapTest3()  {
    ...
    /* ------------------------------------ */
     ...
     /* Testing getTargetedData function for OpenWeatherMap to make sure of its return type */
    @Test
    public void getTargetedDataOpenWeatherMapTest1() throws IOException, ArgumentException{
    ...
    /* Testing getTargetedData function for OpenWeatherMap to make sure that all targeted
     * datas have been selected correctly
     */
    @Test
    public void getTargetedDataOpenWeatherMapTest2() throws IOException, ArgumentException {
        weather.aJsonObject = weather.getFullData("Paris");
        weather.getTargetedData();
        ...
        for (int i = 1; i < weather.targetData.length(); i++) {
            ...
            Assertions.assertTrue(element.has("aWeather"), "L'élément " + i + " ne contient pas la clé 'aWeather'");
